    ...
    if (_dataSource != dataSource)
    {
        ...
        
        {
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                float valueGap = highestValueEColumnChart / 100.0;
...
//    _maxColumnColor = EMaxValueColor;
    _minColumnColor = c_LessThan;
    _maxColumnColor = c_MoreThan;
...
- (void)reloadData
{
    ...
    for (int i = 0; i < totalColumnsRequired; i++)
    {
        ...
        if (nil == eColumn)
        {
           ...
           // NSLog(@"%f",(widthOfTheColumnShouldBe * 0.5 + (i * widthOfTheColumnShouldBe * 1.5)));
            
            eColumn.barColor = c_Qing; // -----Edit Liang -----2014.2.21
