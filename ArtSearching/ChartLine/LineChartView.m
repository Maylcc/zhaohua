...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i=0; i<array.count-1; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(i*vInterval+30, 140, 40, 30)];
        [label setTextAlignment:NSTextAlignmentCenter];
        [label setBackgroundColor:[UIColor clearColor]];
        [label setTextColor:[UIColor whiteColor]];
...
//    CGColorRef pointColorRef = [UIColor colorWithRed:124.0f/255.0f green:152.0f/255.0f blue:100.0f/255.0f alpha:1.0].CGColor;
